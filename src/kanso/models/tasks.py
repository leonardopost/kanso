...
INSTRUCTIONS: Final[dict[TaskClass, str]] = {
    ...
    "propose": (
        ...
        "fact lists the newest of them under this hypothesis: what was tried, the card it "
        "repeated as `like`, and the share of their shared sessions they matched on as "
        "`pct`. Read it as a list of books already measured, and change what the strategy "
