...
INSTRUCTIONS: Final[dict[TaskClass, str]] = {
    ...
    "explore": (
        ...
        "`failing_certification_gates` names the gates its newest failed certificate did "
        "not pass. A corner with many cards and no keep is a corner already searched; write "
        "an idea that tests a mechanism the parent's cards have not reached, not a variation "
        "of its best.\n\n"
