...
that stopped learning — and `kanso inbox` lists the unread ones. Each entry is a single
unchecked-checkbox line carrying an id, a timestamp, the kind, its subject, a summary and
